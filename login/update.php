...
while($row=mysql_fetch_assoc($result))
{
	?>
	<tr>
	<td><input type="text" class="form-control" name="idnew" value="<?php echo $row['sno'];?>" disabled></td>
	<td><input type="text" class="form-control" name="uname" value="<?php echo $row['name'];?>"></td>
	<td><input type="text" class="form-control" name="udes" value="<?php echo $row['des'];?>"></td>
	</tr>
	<?php
}
?>
...
$connect=mysql_connect("localhost","root","");
		...
		if(isset($_POST['update']))
		{
			...
			$upname=$_POST['uname'];
			$updes=$_POST['udes'];
			mysql_query("UPDATE description SET sno='$id' , name='$upname' , des='$updes' WHERE sno='$id'")or die($mysql_error);
		if(update==true)
